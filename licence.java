...
public class Licencia extends JFrame implements ActionListener, ChangeListener{
 ...
 public Licencia(){
  ...
  textarea1.setText("\n\n          T�RMINOS Y CONDICIONES" +
                  "\n\n            A.  PROHIBIDA SU VENTA O DISTRIBUCI�N SIN AUTORIZACI�N DE ALE STUDIOS." +
                  "\n            B.  PROHIBIDA LA ALTERACI�N DEL C�DIGO FUENTE O DISE�O DE LAS INTERFACES GR�FICAS." +
                  "\n            C.  ALE ESTUDIOS NO SE HACE RESPONSABLE DEL MAL USO DE ESTE SOFTWARE." +
                  "\n\n          LOS ACUERDOS LEGALES EXPUESTOS ACONTINUACI�N RIGEN EL USO QUE USTED HAGA DE ESTE SOFTWARE" +
                  "\n          (ALE STUDIOS Y EL AUTOR ALESSANDRO), NO SE RESPONZABILIZAN DEL USO QUE USTED" +
                  "\n          HAGA CON ESTE SOFTWARE Y SUS SERVICIOS. PARA ACEPTAR ESTOS T�RMINOS HAGA CLIC EN (ACEPTO)" +
                  ...
                  "\n          http://www.alestudios.com/alessandrovido" );
