...
public class Principal extends JFrame implements ActionListener{
 ...
 public Principal(){
  ...
  ImageIcon imagen = new ImageIcon("./img/logo-coca.png");
  ...
  textarea1.setForeground(new Color(225, 0 ,0));
 ...
 public void actionPerformed(ActionEvent e){
  ...
  if(e.getSource() == miElCreador){
   JOptionPane.showMessageDialog(null, "Desarrollado por Ale Studios\n"+
                                      "www.alestudios.com/alessandrovido"); 
  }
 }
